...
# استخدم كائنًا محليًا حتى عند الاستيراد كمكتبة؛ لا يتم الاتصال بـ Telegram
# إلا عند استدعاء وظائف الإرسال فعليًا.
bot = telebot.TeleBot(BOT_TOKEN or "0:dummy", parse_mode="HTML")
...
# يمكن استيراد cinema_core كمكتبة من main.py بدون BOT_TOKEN.
if bot is not None:
