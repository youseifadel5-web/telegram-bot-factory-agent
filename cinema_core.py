...
def get_hub_keyboard():
    # البوابة الأساسية تعرض زرًا واحدًا لكل الإضافات.
    # واجهات البوتات نفسها لا تتغير؛ الدخول إليها يتم من Add bot.
    markup = types.InlineKeyboardMarkup(row_width=1)
    markup.add(
        types.InlineKeyboardButton("🎬 بوت سينماء", callback_data="addbot:menu"),
