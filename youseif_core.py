...
def main_menu_kb(uid: int = 0) -> InlineKeyboardMarkup:
    ...
    # لوحة الأدمن يديرها البوت الأساسي من الخارج؛ لا تظهر داخل بوت Youseif.
    rows.append([InlineKeyboardButton("🔙 رجوع لبوت سينماء", callback_data="addbot:menu")])
    return InlineKeyboardMarkup(rows)


def back_main_row() -> List[InlineKeyboardButton]:
    # زر رجوع موحّد: الأول للقائمة الرئيسية داخل Youseif، والثاني لبوابة البوتات.
    return [
