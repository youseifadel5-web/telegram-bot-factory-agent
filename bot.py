                ...
                try:
                    ...
                    if is_callback(upd):
                        ...
                        if data == "hub_home":
                            ...
                            if qmsg:
                                await PTB_BOT.edit_message_text(
                                    chat_id=qmsg.chat.id, message_id=qmsg.message_id,
                                    text="✨ <b>اختر وجهتك السينمائية:</b>",
                                    parse_mode=youseif.ParseMode.HTML,
                                    reply_markup=_hub_keyboard_for(uid),
                                )
                            if uid:
                                USER_MODE[uid] = "cinema"
                            continue
                    ...
                    # Never let one malformed/plugin update kill the shared poller.
